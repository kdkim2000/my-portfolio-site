  ...
  const skillCategories: SkillCategory[] = [
    {
      ...
      color: '#2563eb',
      skills: [
        { name: 'React', level: 40, experience: '2개월', color: '#61DAFB' },
        { name: 'TypeScript', level: 50, experience: '3개월', color: '#3178C6' },
        { name: 'JavaScript', level: 80, experience: '3년', color: '#F7DF1E' },
        { name: 'Vue.js', level: 70, experience: '3년', color: '#4FC08D' },
        { name: 'X-Platform', level: 95, experience: '10년', color: '#06B6D4' },
        { name: 'J-Query', level: 60, experience: '2년', color: '#06B6D4' },
      ],
    },
    {
      id: 'backend',
      ...
      skills: [
        ...
        { name: 'Python', level: 90, experience: '3년', color: '#3776AB' },
        { name: 'Java', level: 95, experience: '15년', color: '#ED8B00' },
        { name: 'Spring Boot', level: 95, experience: '5년', color: '#6DB33F' },
        { name: 'Express.js', level: 75, experience: '1년', color: '#000000' },
        { name: 'Django', level: 50, experience: '4개월', color: '#092E20' },
      ],
    },
    {
      id: 'database',
      ...
      color: '#dc2626',
      skills: [
        { name: 'Oracle', level: 95, experience: '25년', color: '#4479A1' },
        { name: 'PostgreSQL', level: 70, experience: '2년', color: '#336791' },
        { name: 'MongoDB', level: 50, experience: '1년', color: '#47A248' },
        { name: 'Redis', level: 50, experience: '1년', color: '#DC382D' },
      ],
    },
    {
      id: 'devops',
      ...
      color: '#7c3aed',
      skills: [
        { name: 'SCP', level: 90, experience: '2년', color: '#2496ED' },
        { name: 'AWS', level: 60, experience: '3년', color: '#FF9900' },
        { name: 'Docker', level: 60, experience: '3년', color: '#F05032' },
        { name: 'kubernetes', level: 60, experience: '3년', color: '#F05032' },
        { name: 'Git/Github', level: 90, experience: '5년', color: '#FCC624' },
        { name: 'Jenkins', level: 80, experience: '5년', color: '#009639' },
      ],
    },
    {
      id: 'tools',
      ...
      color: '#ea580c',
      skills: [
        { name: 'InteliJ', level: 95, experience: '5년', color: '#007ACC' },
        { name: 'VS Code', level: 95, experience: '5년', color: '#007ACC' },
        { name: 'Powerbuilder', level: 95, experience: '10년', color: '#F24E1E' },
        { name: 'Postman', level: 95, experience: '5년', color: '#FF6C37' },
